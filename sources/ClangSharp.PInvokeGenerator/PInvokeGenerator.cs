...
#else
    private static readonly Regex s_needsSystemSupportRegex = new(@"\b(?:Guid|IntPtr|UIntPtr)\b", RegexOptions.Compiled);
    private static Regex NeedsSystemSupportRegex() => s_needsSystemSupportRegex;
#endif
